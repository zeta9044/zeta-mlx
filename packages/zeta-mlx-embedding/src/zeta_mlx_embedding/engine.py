...
from zeta_mlx_core import Result, Success, Failure, Railway
...
from zeta_mlx_embedding.loader import EmbeddingBundle
...
def create_embedding_engine(
    ...
    """임베딩 엔진 생성"""
    from zeta_mlx_embedding.loader import load_embedding_model
