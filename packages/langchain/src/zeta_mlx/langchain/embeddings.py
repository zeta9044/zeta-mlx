...
from zeta_mlx.core import Result, Failure
...
class MLXLLMEmbeddings(Embeddings):
    ...
    Example:
        from zeta_mlx.langchain import MLXLLMEmbeddings
    ...
    def _ensure_embed_fn(self) -> None:
        ...
        if self.use_sentence_transformers:
            from zeta_mlx.rag import create_sentence_transformer_fn
            ...
            from zeta_mlx.rag import create_simple_embedding_fn
