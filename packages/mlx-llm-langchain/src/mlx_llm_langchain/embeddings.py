...
from mlx_llm_core import Result, Failure
...
class MLXLLMEmbeddings(Embeddings):
    ...
    Example:
        from mlx_llm_langchain import MLXLLMEmbeddings
    ...
    def _ensure_embed_fn(self) -> None:
        ...
        if self.use_sentence_transformers:
            from mlx_llm_rag import create_sentence_transformer_fn
            ...
            from mlx_llm_rag import create_simple_embedding_fn
