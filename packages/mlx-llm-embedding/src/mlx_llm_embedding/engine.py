...
from mlx_llm_core import Result, Success, Failure, Railway
...
from mlx_llm_embedding.loader import EmbeddingBundle
...
def create_embedding_engine(
    ...
    """임베딩 엔진 생성"""
    from mlx_llm_embedding.loader import load_embedding_model
