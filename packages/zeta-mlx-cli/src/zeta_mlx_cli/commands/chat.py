...
def interactive(
    ...
    """대화형 채팅 시작"""
    from zeta_mlx_core import Message, GenerationParams, ChatRequest, Temperature, TopP, MaxTokens, Failure
    from zeta_mlx_inference import load_model_safe, InferenceEngine
